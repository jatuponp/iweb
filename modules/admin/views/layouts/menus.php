...
echo Nav::widget([
    ...
    'encodeLabels'=>false,
    'items' => [
        ['label' => 'Control Panel', 'options' => ['class' => 'nav-header disabled'],'visible'=> !Yii::$app->user->isGuest],
        ...
        ['label' => '<i class="glyphicon glyphicon-book"></i> บริหารแฟ้มเอกสาร', 'url' => ['/admin/document/index'],'active'=> Yii::$app->controller->id=='document','visible'=> Yii::$app->user->can('Editor')],
